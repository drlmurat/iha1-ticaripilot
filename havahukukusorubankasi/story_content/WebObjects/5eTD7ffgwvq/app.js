...
// Gömülü Yedek Soru Veritabanı (Harici dosya yüklenemezse devreye girer - questions.csv ile senkronize)
let QUESTIONS = [
  {
    "question": "Türkiye’nin “üç tarafı denizlerle çevrili olması, İstanbul ve Çanakkale boğazlarına sahip bulunması ve sekiz ülkeyle kara sınırı paylaşması” gibi özellikleri bir bütün olarak değerlendirildiğinde aşağıdaki yargılardan hangisine ulaşılır?",
    "choices": [
      "Türkiye yalnızca deniz yolu taşımacılığında öne çıkan bir ülkedir.",
      "Türkiye’nin lojistik önemi tek bir ulaşım türüne dayanır.",
      "Türkiye, farklı yönlere açılabilen bir geçiş ve bağlantı alanıdır.",
      "Türkiye’nin coğrafi konumu lojistik açıdan dezavantaj oluşturur.",
      "Türkiye’de yalnızca iç ticaret faaliyetleri gelişmiştir."
    ],
    "correct": 2,
    "difficulty": "orta"
  },
  {
    "question": "Aşağıdakilerden hangisi Türkiye’nin matematiksel konumunun (36°–42° kuzey paralelleri, 26°–45° doğu meridyenleri) doğrudan bir sonucudur?",
    "choices": [
      "Asya ile Avrupa arasında köprü olması",
      "Genel olarak ılıman iklim özelliklerinin görülmesi",
      "Sekiz ülkeyle kara sınırı paylaşması",
      "Boğazlara sahip olması",
      "Orta Doğu pazarlarına yakın bulunması"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "“Türkiye’nin üretimi ne kadar düzenli yapılıyorsa taşımacılık ve dağıtım faaliyetleri de o kadar güçlü olur.” cümlesi, iklim ile lojistik arasında nasıl bir ilişki kurmaktadır?",
    "choices": [
      "İklim yalnızca turizmi etkiler, lojistikle ilgisi yoktur.",
      "İklim üretimi etkileyerek dolaylı yoldan lojistiği etkiler.",
      "Lojistik faaliyetler iklimi değiştirir.",
      "İklim yalnızca deniz taşımacılığını etkiler.",
      "Üretim ile taşımacılık arasında ilişki bulunmaz."
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Türkiye’nin kuzeybatısında yer alan, İstanbul merkezli alanın lojistik açıdan ülkenin en gelişmiş kesimlerinden biri olmasının nedeni aşağıdakilerden hangisinde tam olarak verilmiştir?",
    "choices": [
      "Yalnızca tarım alanlarının verimli olması",
      "Yalnızca turizm faaliyetlerinin yoğun olması",
      "Sanayi, ticaret, nüfus, kara-deniz yolu bağlantıları ve boğazların geçiş avantajı",
      "Yalnızca demir yolu hatlarının yoğun olması",
      "Yalnızca sınır kapılarının çok olması"
    ],
    "correct": 2,
    "difficulty": "kolay"
  },
  {
    "question": "Aşağıda Türkiye’nin bazı coğrafi kesimleri ile öne çıkan lojistik özellikleri eşleştirilmiştir. Bu eşleştirmelerden hangisi yanlıştır?",
    "choices": [
      "Kuzeybatı kesimleri – Sanayi ve boğaz geçiş avantajı",
      "Batı kıyıları – Verimli tarım alanları ve limanlar",
      "Güney kıyıları – Mersin ve İskenderun çevresinde liman taşımacılığı",
      "Doğu ve güneydoğu kesimleri – Sınır kapıları ve uluslararası kara taşımacılığı",
      "İç kesimler – Doğrudan deniz taşımacılığı merkezi olma"
    ],
    "correct": 4,
    "difficulty": "orta"
  },
  {
    "question": "Romanya’daki bir limandan yüklenen tahıl gemisinin Karadeniz’den Akdeniz’e ve oradan Kuzey Afrika’ya ulaşabilmesi için izlemesi gereken su yolu aşağıdakilerden hangisidir?",
    "choices": [
      "Süveyş Kanalı – Kızıldeniz",
      "Cebelitarık Boğazı – Atlas Okyanusu",
      "İstanbul Boğazı – Çanakkale Boğazı",
      "Malakka Boğazı – Hint Okyanusu",
      "Basra Körfezi – Hürmüz Boğazı"
    ],
    "correct": 2,
    "difficulty": "orta"
  },
  {
    "question": "Türkiye lojistik coğrafyasında bazen “geçiş ülkesi”, bazen “bağlantı alanı”, bazen de “dağıtım merkezi” olarak değerlendirilmektedir. Bu üç kavramın ortak vurgusu aşağıdakilerden hangisidir?",
    "choices": [
      "Türkiye’nin yalnızca ham madde ürettiği",
      "Türkiye’nin konumundan kaynaklanan aracılık-bağlantı işlevi",
      "Türkiye’nin denize kıyısı olmadığı",
      "Türkiye’nin yalnızca iç ticaretle uğraştığı",
      "Türkiye’nin ulaşım altyapısının zayıf olduğu"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Türkiye’nin doğusunda yer alan komşuları aşağıdaki seçeneklerin hangisinde birlikte ve doğru olarak verilmiştir?",
    "choices": [
      "Yunanistan – Bulgaristan",
      "Irak – Suriye",
      "Gürcistan – Ermenistan – Nahçıvan – İran",
      "Yunanistan – Irak",
      "Bulgaristan – Suriye"
    ],
    "correct": 2,
  ...
  {
    "question": "Bir lojistik şirketi, Uzak Doğu’da üretilen elektronik ürünleri Avrupa, Orta Doğu ve Kuzey Afrika pazarlarına ulaştıracak bir dağıtım merkezi kurmak istemektedir. Denize kıyısı olmayan bir ülke ile Türkiye karşılaştırıldığında Türkiye’yi öne çıkaran temel özellik aşağıdakilerden hangisidir?",
    "choices": [
      "Yüz ölçümünün daha küçük olması",
      "Üç kıtaya yakın konumu ve denizlere açılan ulaşım bağlantıları",
      "Yalnızca tek bir komşusunun bulunması",
      "Hiç limanının olmaması",
      "Yalnızca hava yolu taşımacılığına dayanması"
    ],
    "correct": 1,
    "difficulty": "zor"
  },
  {
    "question": "“Türkiye’nin bulunduğu yer, onu yalnızca bir ülke değil; bir geçiş ve bağlantı alanı hâline getirir.” ifadesi en çok aşağıdaki coğrafi özelliklerden hangisiyle açıklanabilir?",
    "choices": [
      "Türkiye’nin yüz ölçümünün büyük olması",
      "Türkiye’nin Asya ile Avrupa’nın yaklaştığı geçiş alanında bulunması",
      "Türkiye’nin yalnızca tarımsal üretim yapması",
      "Türkiye’nin nüfusunun fazla olması",
      "Türkiye’de yalnızca kara yolu bulunması"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Bir ülkenin lojistik yapısının yalnızca coğrafi konuma değil, doğal ve beşerî özelliklere de bağlı olduğu belirtilmektedir. Aşağıdakilerden hangisi beşerî (insan kaynaklı) bir unsurdur?",
    "choices": [
      "Dağların uzanış yönü",
      "Boğazların varlığı",
      "Denizlere kıyı olma durumu",
  ...
  {
    "question": "Aşağıdakilerden hangisi Türkiye lojistik coğrafyasında yalnızca taşıma dışında yer alan faaliyetlerden biri değildir?",
    "choices": [
      "Depolama",
      "Gümrükleme",
      "Aktarma",
  ...
  {
    "question": "Türkiye’nin matematiksel konumunun düzenli üretime, özel konumunun ise pazarlara yakınlığa katkı sağladığı düşünülürse; hem üretim koşulları hem de Avrupa ve Orta Doğu pazarlarına yakınlık arayan bir tarım şirketi için Türkiye’nin sunduğu avantaj aşağıdakilerden hangisidir?",
    "choices": [
      "Yalnızca ucuz iş gücü",
      "Uygun iklimle üretim ve birden çok pazara coğrafi yakınlık",
      "Yalnızca düşük vergi oranları",
      "Denize kıyısının olmaması",
      "Yalnızca tek pazara erişim"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Türkiye’nin Balkanlar, Kafkasya ve Orta Doğu gibi bölgelere yakın olmasının lojistik açıdan en doğrudan sonucu aşağıdakilerden hangisidir?",
    "choices": [
      "Türkiye’nin yalnızca iç pazara hizmet etmesi",
      "Farklı bölgelere açılan ulaşım ve ticaret köprüsü olması",
      "Türkiye’nin tarım dışı üretiminin durması",
      "Türkiye’nin boğazlarının kapanması",
      "Komşu ülkelerle ticaretin imkânsız hâle gelmesi"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Karadeniz’e kıyısı olan ülkeler arasında kriz çıktığında tahıl taşımacılığının Türk boğazlarına bağımlı hâle gelmesi, Türkiye’nin küresel ticaretteki rolüyle ilgili olarak en çok hangi kavramı öne çıkarır?",
    "choices": [
      "Hinterlant",
      "Geçiş ve kontrol noktası olma",
      "Rezerv para",
      "Enflasyon",
      "İl yolu"
    ],
  ...
  {
    "question": "İstanbul ve Çanakkale boğazlarının lojistik açıdan öneminin yalnızca Türkiye’yi değil, Karadeniz’e kıyısı bulunan diğer ülkeleri de ilgilendirmesinin nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Boğazların yalnızca turizm amaçlı kullanılması",
      "Bu ülkelerin denize çıkışının da boğazlardan geçmesi",
      "Boğazların yalnızca balıkçılıkta kullanılması",
      "Boğazların kara yolu güzergâhı olması",
      "Boğazların yük taşımacılığına kapalı olması"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Aşağıdakilerden hangisi Türkiye’nin enerji taşımacılığı açısından önemini artıran bir özellik değildir?",
    "choices": [
      "Avrupa’ya uzanan kara ve demir yolu hatları",
      "Orta Doğu’ya uzanan kara yolu bağlantıları",
      "Boğazlara ve liman şehirlerine sahip olması",
      "Kıtalar arasında bağlantı kuran konumu",
      "Komşusu bulunmayan bir ülke olması"
    ],
    "correct": 4,
    "difficulty": "kolay"
  },
  {
    "question": "Kara yolu taşımacılığının Türkiye’de en yaygın kullanılan ulaşım türlerinden biri olmasının temel nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "En düşük karbon salımına sahip olması",
      "Esnek olması ve kapıdan kapıya doğrudan ulaşım sağlaması",
      "Yalnızca uzun mesafelerde kullanılması",
      "Tek seferde en büyük yükü taşıması",
      "Hiçbir altyapı gerektirmemesi"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Aşağıda kara yolu türleri ile tanımları eşleştirilmiştir. Hangi eşleştirme doğrudur?",
    "choices": [
      "Otoyol – İl sınırları içinde ilçeleri bağlayan ücretsiz yollar",
      "Devlet yolu – Giriş-çıkışı kontrollü, genellikle ücretli yollar",
      "Uluslararası transit yol – E ve AH yolları olarak adlandırılan koridorlar",
      "İl yolu – Ülkeler arası transit trafiği taşıyan ana koridorlar",
      "Otoyol – Yalnızca yaya ulaşımına açık yollar"
    ],
    "correct": 2,
    "difficulty": "kolay"
  },
  {
    "question": "Türkiye’de kara yolu güzergâhlarının doğu-batı doğrultusunda önem kazanmasının lojistik açıdan en doğru açıklaması aşağıdakilerden hangisidir?",
    "choices": [
      "Yalnızca turistik gezileri kolaylaştırması",
      "Türkiye’yi Avrupa’dan Kafkasya, Türkistan ve Orta Doğu’ya bağlaması",
      "Yalnızca şehir içi ulaşımı sağlaması",
      "Demir yolunu tamamen gereksiz kılması",
      "Limanlara hiçbir bağlantı sağlamaması"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Sınır kapılarının “yalnızca giriş-çıkış noktası” değil, aynı zamanda “lojistik merkez” olarak değerlendirilmesinin nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Yalnızca yolcu pasaport kontrolü yapılması",
      "Gümrük, depolama, tır parkı ve hizmet sektörü gibi faaliyetlerin gelişmesi",
      "Hiçbir ekonomik faaliyet barındırmaması",
      "Yalnızca turistik geçişlere açık olması",
      "Yalnızca demir yolu bağlantısı bulunması"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Aşağıda sınır kapıları ile komşu ülkeler eşleştirilmiştir. Hangi eşleştirme yanlıştır?",
    "choices": [
  ...
  {
    "question": "Almanya’dan yola çıkan ve İran’a otomotiv yedek parçası taşıyan bir tır şoförünün Türkiye’ye Avrupa yönünden giriş yapması beklenir. Bu durumda kullanacağı sınır kapısı aşağıdakilerden hangisidir?",
    "choices": [
      "Habur",
      "Gürbulak",
      "Kapıkule",
  ...
  {
    "question": "Türkiye ile Gürcistan arasında, belirli koşullarda kimlik kartıyla geçişe imkân tanıyan ve Doğu Karadeniz’de yer alan sınır kapısı aşağıdakilerden hangisidir?",
    "choices": [
      "İpsala",
      "Sarp",
      "Gürbulak",
  ...
  {
    "question": "Ermenistan sınırının taşımacılığa kapalı olması, Türkiye’nin Nahçıvan ve dolaylı olarak Azerbaycan ile kara bağlantısında hangi sınır kapısının önemini artırmıştır?",
    "choices": [
      "Dilucu",
      "İpsala",
      "Kapıkule",
  ...
  {
    "question": "Demir yolu taşımacılığının kömür, maden, demir-çelik ve tahıl gibi yüklerde tercih edilmesinin temel nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Her noktaya doğrudan ulaşabilmesi",
      "Tek seferde büyük miktarda yükü ekonomik biçimde taşıyabilmesi",
      "En hızlı ulaşım türü olması",
      "Yalnızca kısa mesafelerde kullanılması",
      "Hiçbir altyapı gerektirmemesi"
    ],
    "correct": 1,
    "difficulty": "kolay"
  ...
  {
    "question": "Bir demir yolu hattının “daha işlevsel” hâle gelmesi için aşağıdakilerden hangisiyle bağlantı kurması en çok beklenir?",
    "choices": [
      "Yalnızca turistik bölgelerle",
      "Limanlar ve sanayi merkezleriyle",
      "Yalnızca tarım alanlarıyla",
      "Yalnızca havalimanı pistleriyle",
      "Yalnızca yerleşim dışı boş alanlarla"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Bakü-Tiflis-Kars Demir Yolu Hattı’nın İstanbul’daki Marmaray ile birleşmesinin lojistik açıdan en önemli sonucu aşağıdakilerden hangisidir?",
    "choices": [
      "Yalnızca şehir içi metro ulaşımının gelişmesi",
      "Asya ile Avrupa arasında kesintisiz demir yolu bağlantısının güçlenmesi",
      "Deniz yolu taşımacılığının tamamen sona ermesi",
      "Yalnızca yolcu taşımacılığının yasaklanması",
      "Kara yolunun gereksiz hâle gelmesi"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Çin’den Avrupa’ya uzanan ve Türkiye’nin de içinde yer aldığı “Orta Koridor”un önemli bir parçası olan demir yolu hattı aşağıdakilerden hangisidir?",
    "choices": [
      "Hicaz Demir Yolu",
      "İzmir-Aydın Demir Yolu",
      "Bakü-Tiflis-Kars Demir Yolu",
      "Yalnızca şehir içi tramvay hatları",
      "Konya-Karaman banliyö hattı"
    ],
    "correct": 2,
    "difficulty": "kolay"
  },
  {
    "question": "Bir limanın hizmet verdiği iç bölgeye verilen ad aşağıdakilerden hangisidir?",
    "choices": [
      "Koridor",
      "Hinterlant",
      "Boğaz",
  ...
  {
    "question": "“Bir limanın ekonomik değeri yalnızca kıyıda bulunmasına değil, geniş bir hinterlanda sahip olmasına bağlıdır.” yargısının nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Geniş hinterlant, limanın yalnızca turistik değerini artırır.",
      "Geniş hinterlant, limanın iç bölgelerdeki üretim ve tüketim alanlarına hizmet etmesini sağlar.",
      "Hinterlant, limanın deniz derinliğini belirler.",
      "Hinterlant, limanın gemi sayısını azaltır.",
      "Hinterlant, yalnızca yolcu taşımacılığını ilgilendirir."
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Aşağıda limanlar ve öne çıkan özellikleri eşleştirilmiştir. Hangi eşleştirme yanlıştır?",
    "choices": [
      "Mersin Limanı – Konteyner taşımacılığı ve Orta Doğu’ya yakınlık",
      "İskenderun Limanı – Demir-çelik ve sanayi yükleri",
      "İzmir Limanı – Tarım ürünleri ve konteyner taşımacılığı",
      "Zonguldak-Ereğli Limanları – Ağır sanayi ve dökme yük",
      "Trabzon Limanı – Avrupa Birliği’ne kara sınırı kapısı"
    ],
    "correct": 4,
    "difficulty": "orta"
  },
  {
    "question": "Bir lojistik firması; Irak, İran ve Suriye pazarlarına kara yolu bağlantısı güçlü, konteyner ve soğuk zincir taşımacılığında gelişmiş, iç bölgelerle demir yolu bağlantısı bulunan bir liman aramaktadır. Bu firmanın tercih etmesi en uygun liman aşağıdakilerden hangisidir?",
    "choices": [
      "Trabzon Limanı",
      "Mersin Limanı",
      "Samsun Limanı",
  ...
  {
    "question": "Karadeniz kıyısındaki limanların lojistik değerinin yalnızca kıyıda bulunmalarından kaynaklanmadığı belirtilmektedir. Bu değeri artıran temel unsur aşağıdakilerden hangisidir?",
    "choices": [
      "İç bölgelere ve komşu ülkelere uzanan ulaşım bağlantıları",
      "Yalnızca balıkçılık faaliyetleri",
      "Yalnızca turizm hareketliliği",
      "Kıyı uzunluğunun kısa olması",
      "Demir yolu bağlantısının hiç olmaması"
    ],
    "correct": 0,
    "difficulty": "kolay"
  },
  {
    "question": "İstanbul Havalimanı’nın Avrupa, Asya ve Afrika yönlü uçuşlarda yolcu ve kargo aktarımında öne çıkmasını sağlayan “aktarma merkezi (HUB)” işlevi en çok aşağıdakilerden hangisiyle açıklanır?",
    "choices": [
      "Yalnızca iç hat uçuşlarına hizmet vermesi",
      "Farklı şehir ve ülkelerden gelen yolcu ve kargonun toplanıp yeniden dağıtılması",
      "Yalnızca turizm sezonunda açık olması",
      "Hava kargo taşımacılığı yapmaması",
      "Yalnızca tek bir ülkeye uçuş düzenlemesi"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Aşağıdaki havalimanlarından hangisinin yaz aylarında yolcu yoğunluğunun ve buna bağlı personel ihtiyacının diğer mevsimlere göre belirgin biçimde artması beklenir?",
    "choices": [
  ...
  {
    "question": "Aşağıda havalimanları ile hizmet işlevleri eşleştirilmiştir. Hangi eşleştirme doğrudur?",
    "choices": [
      "İstanbul Havalimanı – Bölgesel ulaşım havalimanı",
      "Antalya Havalimanı – Uluslararası aktarma merkezi",
      "Dalaman Havalimanı – Turizm odaklı havalimanı",
      "Esenboğa Havalimanı – Yalnızca kargo havalimanı",
      "İzmir Adnan Menderes – Yalnızca iç hat havalimanı"
    ],
    "correct": 2,
    "difficulty": "kolay"
  },
  {
    "question": "Hava kargo taşımacılığında ilaç, elektronik ürün, taze çiçek ve yaş meyve-sebze gibi ürünlerin tercih edilmesinin temel nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Bu ürünlerin çok ağır olması",
      "Bu ürünlerin hızlı taşınma gerektiren, zaman hassasiyeti yüksek ürünler olması",
      "Hava yolunun en ucuz ulaşım türü olması",
      "Bu ürünlerin yalnızca iç hatlarda taşınması",
      "Hava yolunun en yüksek kapasiteye sahip olması"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "İç bölgelerde üretilen malların önce kara veya demir yolu ile limanlara, oradan deniz yolu ile dış pazarlara ulaştırılması en çok aşağıdaki kavramlardan hangisine örnektir?",
    "choices": [
      "Tek bir ulaşım türünün kullanılması",
      "Farklı ulaşım türlerinin birbirini tamamlaması",
      "Yalnızca hava yolunun kullanılması",
      "Ulaşım türleri arasında hiçbir bağlantı olmaması",
      "Yalnızca şehir içi dağıtım"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Hangi ulaşım türünün tercih edileceği; yükün niteliği, mesafe, maliyet, zaman ve coğrafi koşullara göre değişir. Buna göre “küçük bir kasabaya acil paket teslimi” için en uygun ulaşım türü aşağıdakilerden hangisidir?",
    "choices": [
      "Deniz yolu",
      "Demir yolu",
      "Kara yolu",
  ...
  {
    "question": "Aşağıda ulaşım türlerinin özellikleri verilmiştir. Hangi eşleştirme yanlıştır?",
    "choices": [
      "Kara yolu – Kapıdan kapıya yüksek esneklik",
      "Demir yolu – Yüksek kapasite ve düşük emisyon",
      "Deniz yolu – Tek seferde büyük miktarda yük",
      "Hava yolu – En hızlı ama sınırlı kapasiteli",
      "Hava yolu – En düşük maliyetli ulaşım türü"
    ],
    "correct": 4,
    "difficulty": "orta"
  },
  {
    "question": "Taşımacılık ve depolama süreçlerinin çevreye daha az zarar verecek biçimde planlanmasını amaçlayan yaklaşım aşağıdakilerden hangisidir?",
    "choices": [
      "Transit taşımacılık",
      "Yeşil lojistik",
      "Hinterlant yönetimi",
      "Aktarma merkezi sistemi",
  ...
  {
    "question": "Aşağıdakilerden hangisi yeşil lojistik uygulamaları arasında yer almaz?",
    "choices": [
      "Yakıt tasarrufu sağlayan araçların kullanılması",
      "Taşıma güzergâhlarının verimli planlanması",
      "Geri dönüştürülebilir ambalajların tercih edilmesi",
      "Depolarda enerji tasarrufu sağlanması",
      "Fosil yakıt tüketimini artıran araçların yaygınlaştırılması"
    ],
    "correct": 4,
    "difficulty": "kolay"
  },
  {
    "question": "“Düşük emisyon” kavramı lojistik açısından en doğru biçimde aşağıdakilerden hangisiyle açıklanır?",
    "choices": [
      "Taşıma araçlarının daha hızlı gitmesi",
      "Havaya salınan gazların miktarının azaltılması",
      "Taşıma maliyetlerinin yükseltilmesi",
      "Yük kapasitesinin düşürülmesi",
      "Yalnızca kara yolunun kullanılması"
    ],
    "correct": 1,
    "difficulty": "kolay"
  },
  {
    "question": "Demir yolu ve deniz yolu taşımacılığının yeşil lojistik açısından öne çıkmasının temel nedeni aşağıdakilerden hangisidir?",
    "choices": [
      "Birim yük başına daha düşük karbon salımı oluşturmaları",
      "Her noktaya doğrudan ulaşabilmeleri",
      "En hızlı ulaşım türleri olmaları",
      "Hiçbir altyapı gerektirmemeleri",
      "Yalnızca yolcu taşımaları"
    ],
    "correct": 0,
    "difficulty": "orta"
  },
  {
    "question": "“Avrupa Yeşil Mutabakatı” gibi çevresel düzenlemelerin taşımacılık sektörüne en olası etkisi aşağıdakilerden hangisidir?",
    "choices": [
      "Fosil yakıtlı kara yolu taşımacılığının teşvik edilmesi",
      "Daha temiz ve verimli ulaşım türlerine yönelimin artması",
      "Demir yolu yatırımlarının durdurulması",
      "Taşımacılıkta çevre etkilerinin göz ardı edilmesi",
  ...
  {
    "question": "Türkiye’nin bölgesel lojistik avantajları arasında aşağıdakilerden hangisi yer almaz?",
    "choices": [
      "Batıda Avrupa bağlantıları",
      "Güneyde Orta Doğu’ya açılan yollar",
      "Doğuda Kafkasya ve Türkistan bağlantıları",
      "Kuzeyde Karadeniz limanları",
      "Komşu ülkelerle hiçbir ulaşım bağlantısının bulunmaması"
    ],
    "correct": 4,
    "difficulty": "kolay"
  },
  {
    "question": "Komşu bölgelerde yaşanan siyasi sorunların sınır kapılarında beklemelere yol açması, Türkiye’nin lojistik yapısı açısından aşağıdakilerden hangisine örnektir?",
    "choices": [
      "Bölgesel bir lojistik avantaja",
      "Zaman kaybı ve maliyet artışına yol açan bir dezavantaja",
      "Yeşil lojistik uygulamasına",
      "Hinterlandın genişlemesine",
      "Hava kargo kapasitesinin artmasına"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "Sınır geçişlerindeki beklemelere alternatif olarak araçların deniz yolu ile Avrupa’nın merkezine gönderilmesini sağlayan taşımacılık türü aşağıdakilerden hangisidir?",
    "choices": [
      "Boru hattı taşımacılığı",
      "Ro-Ro taşımacılığı",
      "Hava kargo taşımacılığı",
      "Banliyö taşımacılığı",
      "Yalnızca konteyner demir yolu taşımacılığı"
    ],
    "correct": 1,
    "difficulty": "orta"
  },
  {
    "question": "“Türkiye’de yük taşımacılığında kara yolunun ağırlıkta olması” aşağıdaki sonuçlardan hangisini birlikte doğurur?",
    "choices": [
      "Yakıt maliyetlerinin düşmesi ve emisyonun azalması",
      "Yakıt maliyetlerinin yükselmesi ve çevresel etkilerin artması",
      "Demir yolu kapasitesinin tamamen kullanılması",
      "Deniz yolu taşımacılığının imkânsız hâle gelmesi",
      "Lojistik faaliyetlerin tümüyle durması"
    ],
    "correct": 1,
    "difficulty": "zor"
  }
...
function parseCSV(csvText) {
  ...
  const separator = firstLine.trim().startsWith('sep=')
    ? firstLine.trim().slice(4, 5)
  ...
  const dataRows = rows[0] && rows[0][0].toLowerCase().startsWith('sep=') ? rows.slice(2) : rows.slice(1);
  return dataRows.map(columns => {
    const hasFiveChoices = columns.length >= 8;
    const choices = (hasFiveChoices
      ? [columns[1], columns[2], columns[3], columns[4], columns[5]]
      : [columns[1], columns[2], columns[3], columns[4]]
    ).filter(choice => String(choice || '').trim() !== '');
    const answerColumn = hasFiveChoices ? columns[6] : columns[5];
    const difficultyColumn = hasFiveChoices ? columns[7] : columns[6];

    return {
      question: columns[0],
      choices: choices,
      correct: normalizeCorrectAnswer(answerColumn, choices.length),
      difficulty: String(difficultyColumn || 'kolay').trim().toLowerCase()
    };
  }).filter(item => item.question && item.choices.length > 0);
}
...
function normalizeCorrectAnswer(value, choicesLength) {
  const token = String(value || '').trim().toUpperCase();
  const letterIndex = 'ABCDE'.indexOf(token);
  if (letterIndex !== -1) return letterIndex;

  const numericIndex = parseInt(token, 10);
  if (isNaN(numericIndex)) return 0;
  if (numericIndex >= 1 && numericIndex <= choicesLength) return numericIndex - 1;
  if (numericIndex >= 0 && numericIndex < choicesLength) return numericIndex;
  return 0;
}
...
function formatTime(seconds) {
  ...
  return minutes > 0 ? `${minutes}:${remainder}` : `${safeSeconds}s`;
}
...
function startQuiz() {
  ...
  state.answersHistory = Array(QUESTIONS.length).fill(null); // Soru indeksine bağlı cevap kaydı
...
function renderQuestionNavigation() {
  ...
  QUESTIONS.forEach((_, index) => {
    ...
    const answer = state.answersHistory[index];
    btn.type = 'button';
    btn.className = 'question-nav-btn';
    btn.textContent = index + 1;
    btn.setAttribute('aria-label', `${index + 1}. soruya git`);
...
function updateQuizNavigationControls() {
...
function renderAnsweredState(answer) {
  ...
  if (answer.userAnswer >= 0 && choiceButtons[answer.userAnswer]) {
    choiceButtons[answer.userAnswer].classList.add('selected');
  }
}

function saveAnswerForCurrentQuestion(selectedIndex) {
  const q = QUESTIONS[state.currentQuestionIndex];
  const isCorrect = selectedIndex === q.correct;
  const pointsEarned = isCorrect ? getPointsForQuestion(q) : 0;

  state.answersHistory[state.currentQuestionIndex] = {
...
function saveTimeoutForCurrentQuestion() {
  if (state.answersHistory[state.currentQuestionIndex]) return;
...
function fillUnansweredQuestionsAsBlank() {
  QUESTIONS.forEach((q, index) => {
    if (!state.answersHistory[index]) {
      state.answersHistory[index] = {
        questionIndex: index,
        isCorrect: false,
        userAnswer: -1,
        correctAnswer: q.correct,
...
function loadQuestion() {
  ...
  const answered = state.answersHistory[state.currentQuestionIndex];
  state.timeLeft = answered && CONFIG.useTimer ? answered.timeLeft : CONFIG.timerSeconds;
  ...
  if (diffBadgeEl) {
    ...
    const diffText = { "kolay": "Kolay", "orta": "Orta", "zor": "Zor", "cok_zor": "Çok Zor" }[diffKey] || "Kolay";
  ...
  if (CONFIG.useTimer) {
    ...
    document.getElementById('quiz-timer-val').textContent = formatTime(state.timeLeft);
  } else {
  ...
  document.getElementById('question-box').innerHTML = `
    ...
    ${CONFIG.useTimer && !answered ? '<div id="timer-bar" class="timer-line"></div>' : ''}
  `;
  ...
  renderAnsweredState(answered);
  updateQuizNavigationControls();

  // Zamanlayıcıyı sadece cevaplanmamış soruda başlat
  if (CONFIG.useTimer && !answered) {
    startTimer();
  }
}
...
function handleAnswer(selectedIndex, event) {
  ...
  // Sonuç sınav sonunda gösterilir; sınav sırasında yalnızca seçilen cevap işaretlenir.
  saveAnswerForCurrentQuestion(selectedIndex);
  playSound('tick');
...
function goToQuestion(index) {
  if (index < 0 || index >= QUESTIONS.length || index === state.currentQuestionIndex) return;
  playSound('tick');
...
function requestFinishQuiz() {
  const unansweredCount = state.answersHistory.filter(answer => !answer).length;
  if (unansweredCount > 0) {
    const ok = confirm(`${unansweredCount} soru cevaplanmamış. Sınavı yine de bitirmek istiyor musunuz?`);
    if (!ok) return;
  }
  finishQuiz();
}
...
function finishQuiz() {
  clearInterval(state.timerInterval);
  fillUnansweredQuestionsAsBlank();
  state.playerScore = state.answersHistory.reduce((sum, answer) => sum + (answer ? answer.pointsEarned : 0), 0);
...
function reportScoreToLMS(baseScore, maxPossibleScore) {
  ...
  const correctAnswerPercentage = Math.round((state.answersHistory.filter(a => a && a.isCorrect).length / QUESTIONS.length) * 100);
  const isPassed = correctAnswerPercentage >= (CONFIG.passingPercent || 50);
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const prevQuestionBtn = document.getElementById('btn-prev-question');
  const nextQuestionBtn = document.getElementById('btn-next-question');
  const finishQuizBtn = document.getElementById('btn-finish-quiz');
  if (prevQuestionBtn) prevQuestionBtn.addEventListener('click', prevQuestion);
  if (nextQuestionBtn) nextQuestionBtn.addEventListener('click', nextQuestion);
  if (finishQuizBtn) finishQuizBtn.addEventListener('click', requestFinishQuiz);
...
function showSummaryScreen() {
  ...
  // Detayları hesapla
  const totalCorrect = state.answersHistory.filter(a => a && a.isCorrect).length;
  const totalIncorrect = state.answersHistory.filter(a => a && !a.isCorrect).length;
  const baseScore = state.answersHistory.reduce((sum, a) => sum + (a ? a.pointsEarned : 0), 0);
  
  // Kalan saniye süreleri bonus olarak birikiyor
  const accumulatedTimeBonus = state.answersHistory.reduce((sum, a) => {
    return sum + (a && a.isCorrect && CONFIG.useTimer && CONFIG.useTimeBonus ? a.timeLeft : 0);
  }, 0);
  ...
  if (statusLabel) {
    statusLabel.textContent = `Sınav Durumu: ${isPassed ? 'BAŞARILI (GEÇTİ)' : 'BAŞARISIZ (KALDI)'} (Başarı Eşiği: %${CONFIG.passingPercent || 50} - Doğru Oranı: %${correctAnswerPercentage})`;
...
function renderReviewQuestion() {
  ...
  if (CONFIG.useTimer) {
    timeLabel.textContent = `Kalan Süre: ${formatTime(attempt.timeLeft)}`;
  } else {
